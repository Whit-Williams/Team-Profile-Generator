...
const generateTeam = team => {
    ...
    const generateManager = manager => {
        ...
        <div class="card-header">
            ...
            <h3 class="card-title">${manager.getRole()} <i class="fas fa-mug-hot mr-2"></i></h3>
        </div>
        <div class="card-body">
            <ul class="list-group">
    ...
    <div class="card-header">
        ...
        <h3 class="card-title">${engineer.getRole()} <i class="fas fa-glasses mr-2"></i></h3>
    </div>
    <div class="card-body">
        <ul class="list-group">
    ...
    <div class="card-header">
        ...
        <h3 class="card-title">${intern.getRole()} <i class="fas fa-user-graduate mr-2"></i></h3>
    </div>
    <div class="card-body">
        <ul class="list-group">
